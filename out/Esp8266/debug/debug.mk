...
APP_CFLAGS=-DROM_0_URL="\"$(ROM_0_URL)"\" -DROM_1_URL="\"$(ROM_1_URL)"\" -DSPIFFS_URL="\"$(SPIFFS_URL)"\" -DRBOOT_TWO_ROMS=$(RBOOT_TWO_ROMS) -DCOM_SPEED_SERIAL=$(COM_SPEED_SERIAL) -DSERIAL_BAUD_RATE=$(COM_SPEED_SERIAL) -DRBOOT_INTEGRATION -DBOOT_BIG_FLASH -DGDBSTUB_GDB_PATCHED=0
APP_LIBDIR=out/Esp8266/debug/lib
AR=/opt/sming/Sming/esp-quick-toolchain/xtensa-lx106-elf/bin/xtensa-lx106-elf-ar
ARCH_BASE=/opt/sming/Sming/Arch/Esp8266
AS=/opt/sming/Sming/esp-quick-toolchain/xtensa-lx106-elf/bin/xtensa-lx106-elf-gcc
AWK=POSIXLY_CORRECT= awk
BLANK_BIN=/opt/sming/Sming/Components/Storage/blank.bin
BUILD_BASE=$(OUT_BASE)/build
CC=/opt/sming/Sming/esp-quick-toolchain/xtensa-lx106-elf/bin/xtensa-lx106-elf-gcc
CLANG_FORMAT=clang-format
CMAKE=cmake
COM_SPEED_GDB=$(COM_SPEED_SERIAL)
CXX=/opt/sming/Sming/esp-quick-toolchain/xtensa-lx106-elf/bin/xtensa-lx106-elf-g++
ESPTOOL=/opt/sming/Sming/Components/esptool/esptool/esptool.py
ESPTOOL2=/opt/sming/Sming/out/Esp8266/debug/tools/esptool2
ESP_HOME=/opt/sming/Sming/esp-quick-toolchain
...
GCC_VERSION=10.2.0
GDB=/opt/sming/Sming/esp-quick-toolchain/xtensa-lx106-elf/bin/xtensa-lx106-elf-gdb
...
LD=/opt/sming/Sming/esp-quick-toolchain/xtensa-lx106-elf/bin/xtensa-lx106-elf-gcc
LIBMAIN_COMMANDS=$(RBOOT_LIBMAIN_COMMANDS) $(APP_LIBMAIN_COMMANDS)
NINJA=ninja
NM=/opt/sming/Sming/esp-quick-toolchain/xtensa-lx106-elf/bin/xtensa-lx106-elf-nm
OBJCOPY=/opt/sming/Sming/esp-quick-toolchain/xtensa-lx106-elf/bin/xtensa-lx106-elf-objcopy
OBJDUMP=/opt/sming/Sming/esp-quick-toolchain/xtensa-lx106-elf/bin/xtensa-lx106-elf-objdump
OS=
